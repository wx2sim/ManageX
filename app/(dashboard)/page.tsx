...
export default function DashboardPage() {
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      <div>
        <p className="text-xs uppercase tracking-[0.35em] text-pink-600 font-bold">Les Filles</p>
        <h1 className="text-3xl font-bold tracking-tight text-zinc-950 mt-1">Residents Dashboard</h1>
      </div>
