  ...
  return (
    ...
    >
      <div 
        ...
        className="w-full max-w-4xl bg-[#fff5fb] rounded-3xl relative my-auto shadow-[0_20px_100px_rgba(236,72,153,0.25)] flex flex-col animate-in fade-in zoom-in-95 duration-200"
      >
        <button
          onClick={onClose}
